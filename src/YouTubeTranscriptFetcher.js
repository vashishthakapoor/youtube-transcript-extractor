...
class YouTubeTranscriptFetcher {
     ...
     */
    async getAvailableLanguages(videoInput) {
        try {
            // Try to get transcript info without specifying language
            const videoId = this.extractVideoId(videoInput);
            ...
            console.warn('Could not fetch available languages:', error.message);
            return [];
        }
    }
}
